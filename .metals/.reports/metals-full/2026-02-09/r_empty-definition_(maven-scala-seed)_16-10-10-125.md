error id: file:///C:/Users/npott/Documents/musicsort/src/main/scala/musicsort/Editor.scala:musicsort/ProblemAlbumRecord#metadata.
file:///C:/Users/npott/Documents/musicsort/src/main/scala/musicsort/Editor.scala
empty definition using pc, found symbol in pc: musicsort/ProblemAlbumRecord#metadata.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -java/nio/file/record/metadata.
	 -record/metadata.
	 -scala/Predef.record.metadata.
offset: 673
...
object Editor {
  ...
  def promptAllUpdates(record: ProblemAlbumRecord): Unit = {
    println(s"\nAlbum: ${record.me@@tadata.artist.getOrElse("Unknown")} - ${record.metadata.albumName}")
